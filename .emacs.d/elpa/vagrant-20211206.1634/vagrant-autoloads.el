...
Bring up the vagrant box." t nil)

(autoload 'vagrant-provision "vagrant" "\
Provision the vagrant box." t nil)

(autoload 'vagrant-destroy "vagrant" "\
Destroy the vagrant box." t nil)

(autoload 'vagrant-reload "vagrant" "\
Reload the vagrant box." t nil)

(autoload 'vagrant-resume "vagrant" "\
Resume the vagrant box." t nil)

(autoload 'vagrant-ssh "vagrant" "\
SSH to the vagrant box." t nil)

(autoload 'vagrant-status "vagrant" "\
Show the vagrant box status." t nil)

(autoload 'vagrant-suspend "vagrant" "\
Suspend the vagrant box." t nil)

(autoload 'vagrant-halt "vagrant" "\
Halt the vagrant box." t nil)

(autoload 'vagrant-rsync "vagrant" "\
Rsync the vagrant box." t nil)

(autoload 'vagrant-edit "vagrant" "\
Edit the Vagrantfile." t nil)
